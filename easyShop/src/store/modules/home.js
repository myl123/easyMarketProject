...
import { homeData, detailData, topicData, messageData, topicSpecialData, addMessageData, getressData, addressData,deleteressData } from "../../services/homes"
...
export default class Home {
    ...
    @observable getresdata = []

    @observable addresswdata = []

    @observable getressdata=[]
    ...
    @action async getressData() {
        let res = await getressData()
        this.getressdata=res.data
        console.log(res.data)

    }
    @action async addressData(params) {
        let res = await addressData(params)
        // console.log(res)
    }

    @action async deleteressData(params) {
        let res = await deleteressData(params)
        console.log(res)
    }
